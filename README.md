...
<sub>Renders generated by `npm run preview`. The numbers (MMR, rank, score, points, speeds, team colours) come from real matches; player names are placeholders.</sub>
